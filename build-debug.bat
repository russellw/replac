...
clang-cl -DDEBUG /EHsc -I/mpir -Werror -Wimplicit-fallthrough -Wno-assume -Wno-deprecated-declarations -Wno-switch -c -ferror-limit=1 *.cc
if errorlevel 1 goto :eof

rem Then compile with Microsoft C++
cl /DDEBUG /EHsc /MTd /WX /Zi /std:c++17 *.cc setargv.obj dbghelp.lib
if errorlevel 1 goto :eof
